...
export default function ChangeInfo({ navigation }: { navigation: any }) {
    ...
    return (
        <View style={{  flex: 1 }}>
            <View style={{ backgroundColor: '#ffffff', flexDirection: 'row', justifyContent: 'center', padding: 20,
            ...
            <View style={styles.body}>
               ...
               <View style={styles.wrapperBottom}>
                <View style={styles.wrapper}>
                    ...
                    <TextInput style={styles.textRight} editable={false}>Đặng Đình Nguyên</TextInput>
                </View>
                </View> 
                <View style={styles.wrapperBottom}>
                    <View style={styles.wrapper}>
                        <Text style={styles.textLeft}>Số điện thoại</Text>
                        <TextInput style={styles.textRight} editable={false}>0963045765</TextInput>
                    </View>
                    <View style={styles.wrapper}>
                        <Text style={styles.textLeft}>Email</Text>
                        <Text style={styles.textRight}>dinhnguyen@gmail.com</Text>
                    </View>
                    <View style={styles.wrapper}>
                        <Text style={styles.textLeft}>Địa chỉ</Text>
                        <TextInput style={styles.textRight} editable={false}>Thank xuân- Hà nội- Việt Nam</TextInput>
                    </View>
                </View>
            </View>
        </View>
